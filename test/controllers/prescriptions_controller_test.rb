...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { appointment_id: @prescription.appointment_id, description: @prescription.description } }, as: :json
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { appointment_id: @prescription.appointment_id, description: @prescription.description } }, as: :json
    assert_response 200
  end
